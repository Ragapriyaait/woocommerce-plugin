...
function wpme_gravity_forms_get_github_version(){
  ...
  $response = json_decode(wp_remote_retrieve_body(
    wp_remote_get(
      'https://raw.githubusercontent.com/Ragapriyaait/woocommerce-plugin/main/version.json'
    )
  ), true);
...
function wpme_gravity_forms_updater_init($file){
 $GLOBALS['wpme_gravity_downloadLink'] = 'https://github.com/Ragapriyaait/woocommerce-plugin/archive/main.zip';
